...
export const ProductEdit: React.FC = () => {
  ...
  const [formData, setFormData] = useState<DbProduct | null>(null);
    ...
    <div className="flex-1 flex flex-col h-full overflow-y-auto relative scroll-smooth bg-background-light dark:bg-background-dark">
      <div className="flex-1 max-w-[1200px] mx-auto w-full p-6 md:p-10">
        <header className="flex flex-col gap-4 mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-text-main-light dark:text-white tracking-tight line-clamp-1">
            Edit {formData.name}
          </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <label className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full h-12 px-4 rounded-lg bg-surface-light dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-text-main-light dark:text-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all shadow-sm"
                    type="number"
                    min="0"
                    step="0.01"
                  />
